...
class StorageVirtualNode:
    def __init__(
        ...
        self.ip_address: Optional[str] = None  # Assigned by network
        ...
        # Simple routing table (destination_node_id -> next_hop_node_id)
    ...
    def accept_chunk(self, file_id: str, chunk_id: int, source_node: str) -> bool:
        """Accept a chunk directly (used by network simulation)"""
